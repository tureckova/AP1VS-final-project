# Cryptographic password hashing test file
from HashingSoftware import HashPassw, CheckInput, CheckLength
import pytest


def test_HashPassw():
    # HashPassw for successful output
    ...
    assert HashPassw(3, "TezkeHeslo123", "SuperKratkyHash") == 'de6d9d4c3726426'
    'b07eefe687a8ad0e9df4e42e979a40504c0e9350b698b66563'
